...
public class CassandraClient {
	...
	public void createSchema() {
		...
		session.execute("CREATE TABLE IF NOT EXISTS dev.songs ("
				+ "id uuid PRIMARY KEY," + "title text," + "album text,"
				+ "artist text," + "tags set<text>," + "data blob" + ");");
		session.execute("CREATE TABLE IF NOT EXISTS dev.playlists ("
	...
	public void loadData() {
		...
		statement = session.prepare("INSERT INTO dev.playlists "
	...
	public void querySchema() {
		Statement statement = QueryBuilder.select().all().from("dev", "songs");
